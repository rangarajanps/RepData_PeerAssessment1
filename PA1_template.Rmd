...
plot(avwkends$interval, avwkends$av, type="l",xlab="Interval", ylab="Number of Steps")
plot(avwkdays$interval, avwkdays$av, type="l",xlab="Interval", ylab="Number of Steps")
